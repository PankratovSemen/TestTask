...
/****** Object:  Database [TestTask]    Script Date: 06.02.2023 23:24:50 ******/
CREATE DATABASE [TestTask]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'TestTask', FILENAME = N'C:\Users\Семён\TestTask.mdf' , SIZE = 8192KB , MAXSIZE = UNLIMITED, FILEGROWTH = 65536KB )
 LOG ON 
( NAME = N'TestTask_log', FILENAME = N'C:\Users\Семён\TestTask_log.ldf' , SIZE = 8192KB , MAXSIZE = 2048GB , FILEGROWTH = 65536KB )
